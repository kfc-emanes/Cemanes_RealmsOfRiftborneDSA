...
public class CharacterSelectPanel extends JPanel {
    ...
    public CharacterSelectPanel(GameFrame parent) {
        ...
        andrewButton = createImageButton("Andrew (Timeblade)", "/com/ror/model/Assets/Images/Andrew.png");
        flameWarriorButton = createImageButton("Drax (Flame Warrior)", "/com/ror/model/Assets/Images/Drax.png");
        skyMageButton = createImageButton("Flashey (Sky Mage)", "/com/ror/model/Assets/Images/Flashley.png");
        NyxButton = createImageButton("Nyx (Assassin)", "/com/ror/model/Assets/Images/Nyx.png");
        TharnButton = createImageButton("Tharn (Stone Golem)", "/com/ror/model/Assets/Images/Tharn.png");
        ...
        //Button Logic
        andrewButton.addActionListener(e -> parent.showBattle(new com.ror.model.Playable.Andrew()));
        backButton.addActionListener(e -> parent.showMenu());
        flameWarriorButton.addActionListener(e -> parent.showBattle(new com.ror.model.Playable.FlameWarrior()));
        skyMageButton.addActionListener(e -> parent.showBattle(new com.ror.model.Playable.SkyMage()));
        NyxButton.addActionListener(e -> parent.showBattle(new com.ror.model.Playable.Nyx()));
        TharnButton.addActionListener(e -> parent.showBattle(new com.ror.model.Playable.Tharn()));
